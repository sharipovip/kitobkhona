...
### Китобхонаи электронии тоҷикӣ · Манбаи дониш

<div align="center">

![Версия](https://img.shields.io/badge/Версия-2.0.0-gold?style=for-the-badge)
...
### 🔴 Критические
- [ ] `.gitignore` отсутствует — нужно создать!
- [ ] `icon-512.png` весит 1.2MB — нужно оптимизировать
- [ ] `manifest.2.json` — дубликат, удалить
- [ ] `profile_fixed.html` — дубликат, удалить
- [ ] `README.txt` и `README_PATCH.md` — устаревшие, удалить
- [ ] `firebase-messaging-sw.js` (225 байт) — проверить содержание

### 🟡 Архитектура
- [ ] Вынести дублирующиеся стили в общие CSS-файлы
- [ ] Создать общий `components.js` (toast, dialog, esc, bookUrl)
- [ ] Шаблонизировать навигацию (сейчас в каждом HTML вручную)
- [ ] Функции `rawUrl`, `coverCandidates` дублируются — вынести в модуль

### 🟢 Улучшения
- [ ] Добавить `rel="noopener"` для внешних ссылок
- [ ] Улучшить accessibility (aria-метки)
- [ ] Оптимизировать загрузку JS (сейчас всё в одном файле)
...
|--------|------|-----------|
| **2.0.0** | Июнь 2026 | Новый дизайн, чат, лента, рейтинг, админка, кэширование, PWA v5 |
